/* DDL generated by allbow on  27SEP2021:17:50:29 */
/* SAS Flavour DDL for PERSON. */
proc sql;
create table person.EMAILADDRESS(
    BusinessEntityID num format=11. not null label='BusinessEntityID'
   ,EmailAddressID num format=11. not null label='EmailAddressID'
   ,EmailAddress char(100) format=$100.   label='EmailAddress'
