...
;
datalines4;
1,709,John Smith,1695081600,john@fourthcoffee.com,5,"I can't believe I'm singing the praises of a pair of socks, but I just came back from a grueling
...
I won't go on another trip without them!",1695081600
2,937,David,1699920000,david@graphicdesigninstitute.com,4,"A little on the heavy side, but overall the entry/exit is easy in all conditions. I've used these pedals for 
more than 3 years and I've never had a problem. Cleanup is easy. Mud and sand don't get trapped. I would like 
them even better if there was a weight reduction. Maybe in the next design. Still, I would recommend them to a friend.",1699920000
3,937,Jill,1700092800,jill@margiestravel.com,2,"Maybe it's just because I'm new to mountain biking, but I had a terrible time getting use
to these pedals. In my first outing, I wiped out trying to release my foot. Any suggestions on
ways I can adjust the pedals, or is it just a learning curve thing?",1700092800
4,798,Laura Norman,1700092800,laura@treyresearch.net,5,"The Road-550-W from Adventure Works Cycles is everything it's advertised to be. Finally, a quality bike that
...
any level of experience. It's a huge step in the right direction for female cyclists and well worth your consideration and hard-earned money.",1700092800
;;;;
run;
